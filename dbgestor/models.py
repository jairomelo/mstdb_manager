...
class Archivo(models.Model):
    ...
    ubicacion_archivo = models.ForeignKey(
        Lugar, on_delete=models.SET_NULL, null=True, blank=True, related_name='archivos_lugares')
...
class Documento(models.Model):
    ...
    tipo_documento = models.ForeignKey(
        TipoDocumental, on_delete=models.SET_NULL, default=1, null=True, related_name='tipo_documento')
    ...
    lugar_de_produccion = models.ForeignKey(
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.documento_idno:
            expected_idno = f"mx-sv-doc-{str(self.documento_id).zfill(6)}"
            Documento.objects.filter(pk=self.documento_id).update(documento_idno=expected_idno)
            self.documento_idno = expected_idno
...
class Persona(PolymorphicModel):
    ...
    nombres = models.CharField(
        max_length=150, help_text="Nombres sin honoríficos", default="Anónimo")
    ...
    fecha_nacimiento_raw = models.CharField(
        max_length=10, blank=True, null=True)
    fecha_nacimiento_factual = models.BooleanField(null=True, blank=True)
    lugar_nacimiento = models.ForeignKey(
        Lugar, on_delete=models.SET_NULL, null=True, blank=True, related_name='%(class)s_lugar_nac')

    fecha_defuncion = models.DateField(null=True, blank=True)
    fecha_defuncion_raw = models.CharField(
        max_length=10, blank=True, null=True)
    fecha_defuncion_factual = models.BooleanField(null=True, blank=True)
    lugar_defuncion = models.ForeignKey(
        Lugar, on_delete=models.SET_NULL, null=True, blank=True, related_name='%(class)s_lugar_def')

    sexo = models.CharField(max_length=50, choices=SEXOS)

    estado_civil = models.ManyToManyField(EstadoCivil, blank=True)

    ocupaciones = models.ManyToManyField(
        Actividades, related_name='%(class)s_ocupaciones_per', blank=True)
    ocupacion_categoria = models.CharField(
...
class PersonaEsclavizada(Persona):
    ...
    unidad_temporal_edad = models.CharField(
        choices=UNIDADTEMP, max_length=20, null=True, blank=True)
    ...
    procedencia_adicional = models.CharField(
...
class PersonaLugarRel(models.Model):
    ...
    documento = models.ForeignKey(
        Documento, on_delete=models.CASCADE, related_name='p_x_l_documento')
    ...
    lugar = models.ForeignKey(
        Lugar, on_delete=models.CASCADE, related_name='p_x_l_lugar')

    situacion_lugar = models.ForeignKey(
        SituacionLugar, blank=True, null=True, on_delete=models.SET_NULL, related_name='situacion_lugar')

    ordinal = models.SmallIntegerField(default=0)

    fecha_inicial_lugar = models.DateField(null=True, blank=True)
    fecha_inicial_lugar_raw = models.CharField(
        max_length=10, blank=True, null=True)
    ...
    fecha_final_lugar_raw = models.CharField(
        max_length=10, blank=True, null=True)
...
class PersonaRelaciones(models.Model):
    ...
    documento = models.ForeignKey(
        Documento, on_delete=models.CASCADE, related_name='p_x_p_documento', default=1)
    ...
    persona_fuente = models.ForeignKey(
    ...
    fecha_inicial_relacion_raw = models.CharField(
        max_length=10, blank=True, null=True)
    ...
    fecha_final_relacion_raw = models.CharField(
        max_length=10, blank=True, null=True)
...
class PersonaRolEvento(models.Model):
    ...
    documento = models.ForeignKey(
        Documento, on_delete=models.CASCADE, related_name='rol_evento_documento', blank=True)
...
class Corporacion(PolymorphicModel):
    ...
    tipo_institucion = models.ForeignKey(
        TiposInstitucion, on_delete=models.CASCADE)
...
class InstitucionRolEvento(models.Model):
    ...
    documento = models.ForeignKey(Documento, on_delete=models.CASCADE,
                                  related_name='institucion_rol_evento_documento', blank=True)
