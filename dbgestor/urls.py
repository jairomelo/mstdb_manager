...
from .views import (
    ...
    DocumentoUpdateView, EstadoCivilAutocomplete, EstadoCivilCreateView, EtnonimosAutocomplete, EtnonimosCreateView, HispanizacionesAutocomplete,
...
urlpatterns = [
    ...
    path('Add/voc/estado_civil/', EstadoCivilCreateView.as_view(), name='estado_civil_new'),
    # browse views
    ...
    path('estadocivil-autocomplete/', EstadoCivilAutocomplete.as_view(), name='estado_civil_autocomplete'),
